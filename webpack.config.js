...
module.exports = {
    ...
    // Проект теперь собирается вебпаком и при запуске сервера консоль показывает ошибки на других строках 
    // (на компилированном, видоизмененном файле main.js). И трудно разобрать, где именно ошибка.
    // Чтобы в консоли всегда была правильная строка ошибки, добавим строку:
